...
"""
Цикл: 0.011034019000362605
Рекурсия: 0.05052645300020231
Генератор: 0.04820891500094149
...
На последнем рекурсия, но в данном случае от запуска к запуску она меняется местами с генератором. 
"""